...
if (bbp_is_forum_edit()) :
  ...
  $forum_status = bbp_is_single_forum() ? sprintf(esc_html__('Showing Forum &ldquo;%s&rdquo;', 'rise-wp-theme'), bbp_get_forum_title())  : esc_html__('Create a Forum', 'rise-wp-theme');
endif;
    ...
    <div class="connect-tab">
      <div class="mt-10 flex flex-col sm:flex-row justify-between">
        ...
        <div class="flex flex-col lg:flex-row justify-between">
            <?php if ( bbp_has_forums(['post_parent' => 0]) ) : ?>
	                    ...
	                    <?php do_action( 'bbp_template_before_single_forum' ); ?>
                            ...
                            <?php
                                ...
                                if(isset($_GET['sort-by']) && $_GET['sort-by'] == 'popular') {
                                    $topic_args = ['meta_key' => '_bbp_reply_count', 'orderby' => 'meta_value', 'show_stickies' => false];
                                }
                                ...
                                if ( ! bbp_is_forum_category() && bbp_has_topics($topic_args) ) : ?>
