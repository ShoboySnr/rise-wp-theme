	...
	switch ( $privacy ) {
			...
			if ( is_user_logged_in() ) {
				if ( in_array( $has_joined, array( 'approved' ) ) ) { ?>
					<a href="javascript:void(0);" class="um-button um-groups-btn-leave"
						 ...
						 data-group_id="<?php echo esc_attr( $group_id ) ?>">
						<?php echo $button_labels['_leave'] ?>
					</a>
				<?php } elseif ( in_array( $has_joined, array( 'pending_admin_review' ) ) ) { ?>
					<a href="javascript:void(0);" class="um-button um-groups-btn-leave"
						 data-groups-button-hover="<?php echo esc_attr( $button_labels['hover'] ) ?>"
						 data-groups-button-default="<?php echo esc_attr( $button_labels['leave'] ) ?>"
						 data-group_id="<?php echo esc_attr( $group_id ) ?>">
				...
				<?php } elseif ( in_array( $has_joined, array( 'rejected', '' ) ) ) { ?>
					<a href="javascript:void(0);" class="um-button um-groups-btn-join"
						 data-groups-button-default="<?php echo esc_attr( $button_labels['leave'] ) ?>"
						 data-groups-button-hover="<?php echo esc_attr( $button_labels['hover'] ) ?>"
						 data-group_id="<?php echo esc_attr( $group_id ) ?>">
						<?php echo $button_labels['join'] ?>
					</a>
				<?php }
			} else { ?>
				<a href="<?php echo add_query_arg( ['redirect_to' => get_the_permalink( $group_id ) ] , um_get_core_page( 'login' ) ) ?>"
					 class="um-button um-groups-btn-guest">
					<?php _e( 'Join Group', 'um-groups' ) ?>
				</a>
			<?php }
			break;
		...
		default:
			...
			if ( is_user_logged_in() ) {
				...
				<?php } elseif ( in_array( $has_joined, array('') ) ) { ?>
					<a href="javascript:void(0);" class="um-button um-groups-btn-join"
						 data-groups-button-default="<?php echo esc_attr( $button_labels['join'] ) ?>"
						 data-groups-button-hover="<?php echo esc_attr( $button_labels['hover'] ) ?>"
						 data-group_id="<?php echo esc_attr( $group_id ) ?>">
						<?php echo $button_labels['join'] ?>
					</a>
