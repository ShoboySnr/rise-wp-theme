...
class ToolResources {
    ...
    public function get_tools_and_resources($top_filters = '' , $categories = [], $posts_per_page = '') {
            $paged = get_query_var('paged');
            $return_results = [];
        
            $args = [
                'post_type' => RISE_WP_TOOLSRESOURCES,
                'order' => 'DESC',
                'paged' => $paged,
                'tax_query' => [],
    ...
    public function get_related_tools_resources($post_id, $posts_per_page = '') {
        $return_results = [];
