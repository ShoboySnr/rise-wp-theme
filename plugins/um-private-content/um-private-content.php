...
Plugin URI: http://ultimatemember.com/extensions/private-content
...
define( 'um_private_content_requires', '2.1.0' );
...
if ( ! function_exists( 'um_private_content_activation_hook' ) ) {
