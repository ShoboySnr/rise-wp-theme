...
<div style="padding: 0 0; font-size: 16px; text-align: center; line-height: 30px;">View their profile: <a style="color: #3ba1da; text-decoration: none;" href="{friend_profile}">{friend_profile}</a></div>
</div>
