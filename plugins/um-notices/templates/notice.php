...
<div class="um-notices-wrap <?php echo ( $force_id ) ? 'yes-shortcode' : 'no-shortcode'; ?> um-notices-<?php echo esc_attr( UM()->options()->get( 'notice_pos' ) ); ?>" style="<?php echo esc_attr( $style ); ?>" data-notice_id="<?php echo esc_attr( $notice_id ); ?>" data-user_id="<?php echo esc_attr( get_current_user_id() ); ?>">
