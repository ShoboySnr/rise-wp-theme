      ...
      <div class="dashboard-wrap connect-tabs-wrapper">
        <div class="mt-10 flex flex-col lg:flex-row justify-between text-riseBodyText mb-16">
          <div class="flex mb-4 lg:mb-0 items-center font-light text-sm">
            ...
            <p class=""><?= get_page_by_path('connections')->post_title; ?></p>
          </div>
        ...
        <div class="connections-wrapper um-members-wrapper" data-nonce="<?= wp_create_nonce("rise_wp_load_profile_form"); ?>">
            <?= do_shortcode('[rise_wp_bookmarked_members]'); ?>
        </div>
    </div>
</div>
