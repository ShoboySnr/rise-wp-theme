...
class USIN_Includes{
	...
	protected static $autoload_files = array(
		...
		'core/events/' => array(
			'event', 'event-query', 'event-count-query'
		),
		...
		'core/reports/' => array(
			'report','report-options','period-report','standard-report', 'standard-report-with-period-filter',
		...
		'core/query/' => array('query', 'user-query', 'coordinates-query', 'meta-query', 'post-query', 'combined-filter-condition-builder'),
