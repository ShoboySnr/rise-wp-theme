...
class USIN_MemberPress_Query {
	...
	public function filter_db_map($db_map) {
		...
		$db_map['mepr_active_memberships'] = array('db_ref' => 'names', 'db_table' => 'mepr_memberships', 'custom_select' => true, 'set_alias' => true);
	...
	public function filter_query_select($query_select, $field) {
		...
		} elseif ($field == 'mepr_active_memberships'){
			$query_select = "GROUP_CONCAT(DISTINCT (IF(mepr_memberships.is_active IS TRUE, mepr_memberships.product_id, NULL)) SEPARATOR ',')";
		}
		return $query_select;
	}
