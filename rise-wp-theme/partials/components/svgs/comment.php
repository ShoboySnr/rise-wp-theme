<svg class="mr-3.5" width="22" height="22" viewBox="0 0 22 22" fill="none"
    ...
    <path d="M14.9394 11.4131H14.9484" stroke="#A9A9A9" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round" />
    <path d="M10.9304 11.4131H10.9394" stroke="#A9A9A9" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round" />
    <path d="M6.9214 11.4131H6.9304" stroke="#A9A9A9" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round" />
</svg>
